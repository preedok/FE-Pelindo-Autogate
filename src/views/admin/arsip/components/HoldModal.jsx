...
const HoldModal = ({ open, handleClose, dataDetail, reason, setReason, loading, handleHold }) => {
    return (
        <Modal
            open={open}
            onClose={handleClose}
            ...
            <Box sx={style}>
                ...
                <Typography id="modal-modal-description" sx={{ mt: 2 }}>
                    ...
                    <div className="flex ms-auto justify-end mt-5">
                        <Button variant='contained' size="small" onClick={handleHold} disabled={loading}>
                            {loading ? <CircularProgress size={20} color="inherit" /> : 'Hold'}
                        </Button>
                    </div>
                </Typography>
            </Box>
